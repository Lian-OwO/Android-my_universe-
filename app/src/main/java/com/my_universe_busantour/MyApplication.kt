...
import com.my_universe_busantour.api.NaverNetworkService
import com.my_universe_busantour.retrofit.ResourceServerNetwork
...
class MyApplication : MultiDexApplication() {
    val okHttpClient = OkHttpClient.Builder()
        ...
        .build()
    val SERVER_BASE_URL : String = "http://43.202.57.53:8083/"
    ...
    val networkService : com.my_universe_busantour.api.INetworkService
...
//            .baseUrl("http://apis.data.go.kr/6260000/RecommendedService/")
    ...
    init {
        ...
        networkService = retrofit.create(com.my_universe_busantour.api.INetworkService::class.java)
