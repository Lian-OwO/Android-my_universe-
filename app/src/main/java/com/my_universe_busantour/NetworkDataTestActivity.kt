...
import com.my_universe_busantour.mainAdapter.MyAdapterRetrofit77
import com.my_universe_busantour.databinding.ActivityNetworkDataTestBinding
...
class NetworkDataTestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 1
        val networkService = (applicationContext as com.my_universe_busantour.MyApplication).networkService
